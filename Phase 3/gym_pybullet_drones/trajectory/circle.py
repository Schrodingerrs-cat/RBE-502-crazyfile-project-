...
# def circle(t, tf=15):
#     """
#     3-phase circle trajectory:

#         Phase 1: Hover → circle entry    (0–5 s)
#         Phase 2: Circular trajectory     (5–10 s)
#         Phase 3: Circle → hover          (10–15 s)
#         After 15 s: hold hover at (0,0,0.5)
#     """
...
#         end_circle = np.array([R * np.cos(theta_end), R * np.sin(theta_end), 1.0])

#         hover = np.array([0.0, 0.0, 0.5])
