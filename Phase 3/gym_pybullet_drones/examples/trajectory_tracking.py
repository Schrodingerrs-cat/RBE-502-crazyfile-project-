...
# ):
#     """Run a trajectory tracking episode.

#     If return_logger is True, returns the Logger instance for use by
#     the RL tuner instead of plotting/saving.
#     """
...
#         ctrl = [DSLPIDControl(drone_model=drone) for i in range(num_drones)]
#     else:
#         raise ValueError("DSLPIDControl only supports CF2X/CF2P")
...
#     #### For tuner: return logger directly #####################
#     if return_logger:
#         return logger

#     #### Save / plot in standalone mode ########################
#     if plot:
#         logger.plot()
...
#         default=DEFAULT_DURATION_SEC,
#         type=int,
#         help="Duration of the simulation in seconds (default: 20)",
#         metavar="",
#     )
#     parser.add_argument(
#         "--output_folder",
